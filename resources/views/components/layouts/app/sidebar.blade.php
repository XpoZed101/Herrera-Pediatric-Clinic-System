        ...
        <flux:sidebar sticky stashable class="border-e border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900 shadow-sm">
            ...
            <flux:navlist variant="outline">
                ...
                <flux:navlist.group :heading="__('Platform')" class="grid">
                        ...
                        <flux:navlist.item icon="queue-list" :href="route('admin.doctor.queue')" :current="request()->routeIs('admin.doctor.queue')" wire:navigate class="[&_*[data-slot=icon]]:text-sky-600">{{ __('Queue') }}</flux:navlist.item>
